<?php
  ...
  if (!isset($_SESSION['login_admin'])) {
    ...
    $sql = "SELECT * FROM receive INNER JOIN type ON receive.Type_T_id = type.T_id INNER JOIN unit ON receive.unit_u_id = unit.u_id ORDER BY r_date DESC";
      ...
      <li class="mb-1">
        ...
        <div class="collapse show" id="dashboard-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li><a href="receive_sum.php" class="link-dark d-inline-flex text-decoration-none rounded bg-primary">ສິນຄ້ານຳເຂົ້າທັງໝົດ</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
