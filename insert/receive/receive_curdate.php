<?php
    ...
    $sql = "SELECT * FROM receive INNER JOIN type ON receive.Type_T_id = type.T_id INNER JOIN unit ON receive.unit_u_id = unit.u_id WHERE r_date = curdate()";
...
<?php if (isset($_SESSION['success'])) { ?>
   ...
   <?php if ($count == 0) { ?>
    ...
    <?php } else { ?>
      ...
      <a href="receive_curdate.php?search_id='1'" class="btn btn-outline-success"><i class="fa-solid fa-barcode"></i> ຄົ້ນດວ້ຍບາໂຄດ</a>
            ...
            <?php if (isset($_GET['search'])) { ?>
                  <form action="search_receive_curdate.php" method="post" class="form-search">
                    <label for="">ຄົ້ນຫາຊື່ສິນຄ້າ</label>
                    <input type="text" name="search_name" id="" class="form-control">
                    <button type="submit" name="search" class="btn btn-outline-primary"><i class="fa-solid fa-magnifying-glass"></i> ຄົ້ນຫາ</button>
                    <a href="receive_curdate.php" class="btn btn-outline-success"><i class="fa-solid fa-rotate-left"></i> ກັບຄືນ</a>
                  </form>
              <?php } ?>
              ...
              <?php if (isset($_GET['search_id'])) { ?>
                <form action="search_receive_curdate.php" method="POST" class="form-search">
                  <label for="">ຄົ້ນຫາດວ້ຍຍາໂຄດ</label>
                  <input type="text" name="select_id" class="form-control">
                  <button type="submit" name="search_id" class="btn btn-outline-info"><i class="fa-solid fa-barcode"></i> ຄົ້ນຫາດວ້ຍບາໂຄດ</button>
                  <a href="receive_curdate.php" class="btn btn-outline-success"><i class="fa-solid fa-rotate-left"></i> ກັບຄືນ</a>
                </form>
                <?php } ?>
