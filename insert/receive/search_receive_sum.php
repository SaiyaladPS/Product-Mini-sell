<?php 
      ...
      $query_profile_ligin = mysqli_query($conn,$sql_profile_login);
        ...
        if (isset($_POST['search'])) {
                ...
                INNER JOIN unit ON unit.u_id = receive.unit_u_id WHERE r_name LIKE '%$search_name%' ORDER BY r_name ASC";
                ...
                Swal.fire({
                        icon: 'success',
                        title: 'ຄົ້ນຫາຂໍ້ມູນທີ່ຕົງກັບ $search_name ພົບ $count ລາຍງານ',
      ...
      <li class="mb-1">
        ...
        <div class="collapse show" id="dashboard-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li><a href="../receive/receive_sum.php" class="link-dark d-inline-flex text-decoration-none rounded bg-primary">ສິນຄ້ານຳເຂົ້າທັງໝົດ</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
                            ...
                            <tbody>
                                <?php while($row = mysqli_fetch_assoc($search_receive_curdate_query)) { ?>
                                    <tr><td><?php echo $number++ ?></td>
                                        ...
                                        <td><a href="receive_sum_db.php?delete=<?php echo $row['r_id'] ?>&delete_name=<?php echo $row['r_name'] ?>" class="btn btn-outline-danger" style="font-size: 12px;"><i class="fa-solid fa-trash"></i> ລົບ</a></td>
