<?php
     ...
     if (isset($_GET['delete'])) {
        ...
        $_SESSION['error'] = "<script>Swal.fire({
            ...
            window.location.href = 'receive_curdate_db.php?delete_confirm=" . $delete . "&delete_r_name=" .$delete_name. "'
            } else {
            window.location.href = 'receive_curdate_db.php?delete_not=" . $delete . "&delete_r_name=".$delete_name."'
            }
            })</script>";
            header("location: receive_curdate.php");
    }
